...
@interface ECDChatWithTabBarVC () <UITabBarDelegate>

@property (assign, nonatomic) CGRect keyboardFrame;

@end

@implementation ECDChatWithTabBarVC
...
- (void)viewDidLoad {
    ...
    NSLayoutConstraint *top = [NSLayoutConstraint constraintWithItem:self.chatController.view
    ...
    NSLayoutConstraint *bottom = [NSLayoutConstraint constraintWithItem:self.chatController.view
    ...
    NSLayoutConstraint *left = [NSLayoutConstraint constraintWithItem:self.chatController.view
    ...
    NSLayoutConstraint *right = [NSLayoutConstraint constraintWithItem:self.chatController.view
    ...
    [self.chatView addSubview:self.chatController.view];
