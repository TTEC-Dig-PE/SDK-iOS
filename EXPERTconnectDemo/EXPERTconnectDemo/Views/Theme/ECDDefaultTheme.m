...
@implementation ECDDefaultTheme
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        self.primaryTextColor = [UIColor lightTextColor];
        self.secondaryTextColor = [UIColor lightGrayColor];
        self.primaryBackgroundColor = [UIColor blackColor];
        self.secondaryBackgroundColor = [UIColor colorWithRed:0.1f green:0.1f blue:0.1f alpha:1.0f];
        ...
        NSString *path = [[NSBundle mainBundle] pathForResource:@"ECDDefaultTheme" ofType:@"css"];
