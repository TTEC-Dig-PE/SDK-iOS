...
@implementation ECSJourneyAttachResponse
/*
...
-(NSString *)description {
    return [NSString stringWithFormat:@"ContextId: %@, Journey: %@, tenantId: %@, name: %@, userId: %@, creationTime: %@, deviceType=%@, lastActivityTime=%@",
            self.contextId,
            self.journeyId,
            self.tenantId,
            self.name,
