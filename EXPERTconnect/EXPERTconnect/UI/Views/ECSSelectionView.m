...
@interface ECSSelectionView ()

@property (nonatomic, assign) CGRect initialFrame;

@end

@implementation ECSSelectionView
...
- (void)drawRect:(CGRect)rect
{
    if((_startIndex >= 0) || (_endIndex >= 0)) 
    {
        ...
        CGFloat cornerRadius = [[[ECSThemeEngine sharedInstance] elementOfGenericType:PMThemeCornerRadiusGenericType
        ...
        NSString *coordinatesRound = [[ECSThemeEngine sharedInstance] elementOfGenericType:PMThemeCoordinatesRoundGenericType
                                                                                  subtype:PMThemeBackgroundSubtype
