...
@interface ECSCalendarBackgroundView ()
...
@implementation ECSCalendarBackgroundView
...
+ (UIBezierPath*) createBezierPathForSize:(CGSize) size
                           arrowDirection:(ECSCalendarArrowDirection)direction
...
-(void)drawRect:(CGRect)rect
{
    ...
    NSDictionary *shadowDict = [[ECSThemeEngine sharedInstance] elementOfGenericType:PMThemeShadowGenericType
                                                                            subtype:PMThemeMainSubtype
                                                                               type:PMThemeBackgroundElementType];
    ECSThemeShadow *innerShadow = [[ECSThemeShadow alloc] initWithShadowDict:shadowDict];
    ...
    UIBezierPath *roundedRectanglePath = [ECSCalendarBackgroundView createBezierPathForSize:boxBounds.size
                                                                            arrowDirection:self.arrowDirection
                                                                             arrowPosition:self.arrowPosition];

    [[ECSThemeEngine sharedInstance] drawPath:roundedRectanglePath
    ...
    NSNumber *separatorWidthNumber = [[ECSThemeEngine sharedInstance] elementOfGenericType:PMThemeSizeWidthGenericType
                                                                                  subtype:PMThemeMainSubtype
    ...
    if (separatorWidthNumber)
    {
        ...
        for (int i = 0; i < 6; i++) 
        {
            ...
            [[ECSThemeEngine sharedInstance] drawPath:dividerPath
