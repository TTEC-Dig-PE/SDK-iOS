...
{
    [super viewDidLoad];
    [self.choiceTable registerNib:[ECSCheckboxTableViewCell ecs_nib] forCellReuseIdentifier:ECSCheckboxTableViewCellIdentifier];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BOOL selected = [answerArray containsObject:answer];
    ...
    [self.delegate formItemViewController:self answerDidChange:nil forFormItem:item];
}
...
- (void)tableView:(UITableView *)tableView didDeselectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        // deselect
        [mutableAnswers removeObject:answer];
    }
